...
\begin{hwkProblem*}{1}{Problem Setup} \label{hwk:p01}
	...
	\begin{figure}[H] \label{fig:s01e}
		\begin{center}
			\includegraphics[width=0.65\textwidth]{./outputs/figures/s01e.png}
		\end{center}
...
\begin{hwkProblem*}{3}{Pure Prediction} \label{hwk:p03}
	...
	\begin{figure}[H] \label{fig:s03c}
		\begin{center}
			\includegraphics[width=0.65\textwidth]{./outputs/figures/s03c.png}
		\end{center}
		\caption{\( \pm 3 \sigma \) Bounds on Covariance \( P_{\bm{\hat{x}}, k}^{-} \) vs. Time \( t \)}
	\end{figure}
...
\begin{hwkProblem*}{4}{Measurement Updates} \label{hwk:p04}
	...
	\begin{figure}[H] \label{fig:s04b}
		\begin{center}
			\includegraphics[width=0.65\textwidth]{./outputs/figures/s04b.png}
		\end{center}
		\caption{Example}
	\end{figure}
	...
	\begin{figure}[H] \label{fig:s04c}
		\begin{center}
			\includegraphics[width=0.65\textwidth]{./outputs/figures/s04c.png}
		\end{center}
		\caption{Example}
	\end{figure}
...
\begin{hwkProblem*}{5}{Filter Solutions} \label{hwk:p05}
	...
	\begin{figure}[H] \label{fig:s05c}
		\begin{center}
			\includegraphics[width=0.65\textwidth]{./outputs/figures/s05c.png}
		\end{center}
		\caption{Example}
	\end{figure}
